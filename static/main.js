...
function getKey(keyList, uuid){
	for(var i = 0; i < keyList.length; i++){
		if(keyList[i].KeyId == uuid) {
			return keysList[i].Key;
		}
	}
	return "UNKNOWN";
}
		...
		lookupModules(storeId, function(modules) {
			lookupKeys(storeId, function(keys) {
				...
				for(var i = 0; i < modules.length; i++){
					...
					var contentKey = getKey(keysList, modules[i].KeyId);
...
function print_download2(ih, name, pos) {
    let dlbtn, before = '',
        after = '',
        lnk;
    return before + '<div id="mc-downloads"><a id="fetching_info" href="javascript:void();"><img src="/images/icon-loading.gif" /> Fetching Info... </a></div>' + after;
}
...
function print_browse() {
    document.write('<section class="col-center">\n', '<dl class="row">\n', '<div class="category_list">\n', '<div>\n', '<dt><a href="/search.php?q=category:100" title="Marketplace Items">Marketplace Items</a></dt>\n', '<dd>\n', '<a href="/search.php?q=category:1" title="Skin Packs">Skin Packs</a>\n', '<a href="/search.php?q=category:2" title="Worlds">Worlds</a>\n', '<a href="/search.php?q=category:3" title="Resource Packs">Resource Packs</a>\n', '<a href="/search.php?q=category:4" title="Personas">Personas</a>\n', '</div>\n', '</dd>', '</dl>\n', '</section>\n');
}

function print_top() {
    document.write('<section class="col-center">\n', '<dl class="row">\n', '<div class="category_list">\n', '<b><a href="/search.php?q=top100:all">Total Top100</a></b>', '</dd>\n', '</div>\n', '</div>\n', '</dl>\n', '</section>\n');
}
